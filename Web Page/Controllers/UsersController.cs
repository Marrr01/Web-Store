...
namespace Controllers
{
    ...
    //    public async Task<IActionResult> Create([Bind("Login,Password,Email,IsAdmin,Name,Surname,Age")] User user)
    //    {
    ...
    //    [HttpPost]
    //    [ValidateAntiForgeryToken]
    //    public async Task<IActionResult> Edit(string id, [Bind("Login,Password,Email,IsAdmin,Name,Surname,Age")] User user)
    //    {
    //        if (id != user.Login)
    //        {
    //            return NotFound();
